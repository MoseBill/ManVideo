...
//    self.repulse_content_textView.text = @"请描述您举报的内容～";
...
//    self.max_textCont_label.text = @"500字内";
    ...
    [self.repulse_cancel_button setTitle:NSLocalizedString(@"VDCancelText", nil) forState:UIControlStateNormal];
...
//    [self.repulse_makeSure_button setTitle:@"举报" forState:UIControlStateNormal];
