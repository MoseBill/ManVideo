...
- (void)viewDidLoad {
    [super viewDidLoad];
  self.view.backgroundColor = [UIColor je_gradientFromColor:[UIColor colorWithHexString:@"54ceee"] toColor:[UIColor colorWithHexString:@"31acf1"] withHeight:SCREEN_HEIGHT];
}
