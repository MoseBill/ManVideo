...
- (void)dealloc{
    [kAPPWindow removeObserver:self
                    forKeyPath:@"frame"];
}
...
- (void)setupToolbars
{
    ...
    [saveButton setTitle:NSLocalizedString(@"VDsaveText", nil) forState:UIControlStateNormal];
...
- (void)saveImage
{
    ...
    [kAPPWindow addSubview:indicator];
...
- (void)image:(UIImage *)image didFinishSavingWithError:(NSError *)error contextInfo:(void *)contextInfo;
{
    ...
    [kAPPWindow bringSubviewToFront:label];
    if (error) {
