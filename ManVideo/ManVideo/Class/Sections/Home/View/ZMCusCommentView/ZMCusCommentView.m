...
//        [self.modelArr addObject:model];
    ...
    ZMCusCommentView *cusView = [[ZMCusCommentView alloc] init];
//    WithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT)
    cusView.frame = CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT);
    // 发送通知数据
    ...
    [delegate.window addSubview:cusView];
//    [self showView];
    [cusView showView];
