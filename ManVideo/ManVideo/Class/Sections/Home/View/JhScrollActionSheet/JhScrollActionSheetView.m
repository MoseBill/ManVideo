...
-(void)setUpSubviews{
    ...
    _actionSheetView.backgroundColor =  [UIColor colorWithHexString:@"050013"];
    _cancelBtn.backgroundColor = [UIColor colorWithHexString:@"19132B"];
...
-(UIButton *)cancelBtn{
    if (!_cancelBtn) {
        ...
        [cancelBtn setTitle:NSLocalizedString(@"VDCancelText", nil) forState:UIControlStateNormal];
