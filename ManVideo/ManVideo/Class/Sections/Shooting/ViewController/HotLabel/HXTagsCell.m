...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.layer.borderColor = [UIColor colorWithHexString:@"D32EA6"].CGColor;
    cell.layer.cornerRadius = cell.height/2.0f;
    cell.layer.borderWidth = 1.0f;
    cell.titleLabel.textColor = [UIColor colorWithHexString:@"D32EA6"];
    ...
    if ([self.selectedTags containsObject:self.tags[indexPath.item]]) {
        cell.backgroundColor = [UIColor colorWithHexString:@"4D52BD"];
...
- (UICollectionView *)collectionView {
    if (!_collectionView) {
        _collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 50, self.frame.size.width, 362) collectionViewLayout:_layout];
