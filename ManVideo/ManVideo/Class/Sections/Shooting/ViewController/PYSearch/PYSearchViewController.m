...
- (void)viewDidLoad {
    ...
    self.titleView.text = [NSString stringWithFormat:NSLocalizedString(@"VDSearchText", nil)];
...
//        navigationBarLayoutMargins = navigationBar.layoutMargins;
    ...
    searchBar.backgroundColor = [UIColor colorWithHexString:@"0F0920"];
...
//        searchBar.py_height = 80;
//        searchBar.py_width = SCREEN_WIDTH;
        searchBar.backgroundColor = kClearColor;
        searchField.frame = searchBar.bounds;
        searchField.textColor = kWhiteColor;
        searchField.layer.borderColor = [UIColor colorWithHexString:@"221c31"].CGColor;
        searchField.backgroundColor = [UIColor colorWithHexString:@"221c31"];
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    if (NO == self.navigationController.navigationBar.translucent) {
        ...
        self.searchSuggestionVC.view.frame = CGRectMake(0, CGRectGetMaxY(self.searchBar.frame) - self.view.py_y, self.view.py_width, self.view.py_height + self.view.py_y);
...
+ (instancetype)searchViewControllerWithHotSearches:(NSArray<NSString *> *)hotSearches searchBarPlaceholder:(NSString *)placeholder
{
    ...
    searchVC.searchBar.placeholder = [NSString stringWithFormat:NSLocalizedString(@"VDSearchText", nil)];
    return searchVC;
}
...
- (UITableView *)baseSearchTableView
{
    if (!_baseSearchTableView) {
        UITableView *baseSearchTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, Height_NavBar+34/667.0f*(HEIGHT_SCREEN+Height_NavBar+Height_TabBar), SCREEN_WIDTH, SCREEN_HEIGHT-Height_TabBar) style:UITableViewStyleGrouped];
        baseSearchTableView.backgroundColor = [UIColor colorWithHexString:@"050013"];
...
#pragma clang diagnostic pop
        ...
        searchSuggestionVC.view.frame = CGRectMake(0, CGRectGetMaxY(self.searchBar.frame), PYScreenW, PYScreenH);
...
- (void)setup
{
    self.backBtn = ({
        ...
        [b setImage:[UIImage imageNamed:@"icon_return"] forState:UIControlStateNormal];
        b;
    });
    self.backBtn.frame = CGRectMake(0, 0, 44, 44);
  
    UIBarButtonItem *leftItem = [[UIBarButtonItem alloc]initWithCustomView:self.backBtn];
    self.gk_navigationItem.leftBarButtonItem = leftItem;
...
//    self.navigationController.navigationBar.backIndicatorImage = nil;
    ...
    [cancleButton setTitle:NSLocalizedString(@"VDCancelText", nil) forState:UIControlStateNormal];
    [cancleButton setTitleColor:[UIColor colorWithHexString:@"EB3053"] forState:UIControlStateNormal];
...
//    UIView *titleView = [[UIView alloc] initWithFrame:CGRectMake(0, Height_NavBar, SCREEN_WIDTH, 80)];
    
    UISearchBar *searchBar = [[UISearchBar alloc] initWithFrame:CGRectMake(15/375.0f*SCREEN_WIDTH, Height_NavBar, 285/375.0f*SCREEN_WIDTH, 36/667.0f*(HEIGHT_SCREEN+Height_NavBar+Height_TabBar))];
    searchBar.backgroundColor = kClearColor;
    searchBar.barTintColor = kWhiteColor;
    searchBar.tintColor = kWhiteColor;
    [self.view addSubview:searchBar];
    UIImage* searchBarBg = [self GetImageWithColor:[UIColor clearColor] andHeight:32.0f];
    
    [searchBar setBackgroundImage:searchBarBg];
//    cancleButton.frame = CGRectMake(313, 80, 50, 13);
    [cancleButton mas_remakeConstraints:^(MASConstraintMaker *make) {
         make.left.mas_equalTo(searchBar.mas_right).offset(13);
...
//    [self.view addSubview:titleView];
    searchBar.placeholder = [NSString stringWithFormat:NSLocalizedString(@"VDSearchText", nil)];
//    searchBar.backgroundImage = [NSBundle py_imageNamed:@"clearImage"];
    ...
    emptySearchHistoryLabel.textColor = [UIColor colorWithHexString:@"B0B0B0"];
...
//    contentView.backgroundColor = [UIColor whiteColor];
    ...
    for (int i = 0; i < self.hotSearches.count; i++) {
        ...
        rectangleTagLabel.textColor = [UIColor colorWithHexString:@"B0B0B0"];
    ...
    switch (searchHistoryStyle) {
        ...
        case PYSearchHistoryStyleBorderTag:
            for (UILabel *tag in self.searchHistoryTags) {
                ...
                tag.layer.borderColor = [UIColor colorWithHexString:@"D32EA6"].CGColor;
    ...
    switch (hotSearchStyle) {
        ...
        case PYHotSearchStyleARCBorderTag:
            for (UILabel *tag in self.hotSearchTags) {
                ...
                tag.layer.borderWidth = 0.5;
                tag.layer.cornerRadius = tag.py_height * 0.5;
                tag.textColor = [UIColor colorWithHexString:@"D32EA6"];
            }
            break;
