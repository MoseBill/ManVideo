...
- (UIView *)alertView {
    if (!_alertView) {
        _alertView = [[UIView alloc]initWithFrame:CGRectMake(0,
                                                             SCREEN_HEIGHT - self.manager.kTopViewH - self.manager.kPickerViewH,
                                                             SCREEN_WIDTH,
                                                             self.manager.kTopViewH + self.manager.kPickerViewH)];
...
- (UIButton *)leftBtn {
    if (!_leftBtn) {
        ...
        [_leftBtn setTitleColor:self.manager.leftBtnTitleColor
                       forState:UIControlStateNormal];
        [_leftBtn setTitle:self.manager.leftBtnTitle
                  forState:UIControlStateNormal];
...
- (UIButton *)rightBtn {
    if (!_rightBtn) {
        ...
        _rightBtn.frame = CGRectMake(SCREEN_WIDTH - 95, 7, 90, self.manager.kTopViewH-14);
...
- (UILabel *)titleLabel {
    if (!_titleLabel) {
        _titleLabel = [[UILabel alloc]initWithFrame:CGRectMake(65,
                                                               0,
                                                               SCREEN_WIDTH - 160,
                                                               self.manager.kTopViewH)];
