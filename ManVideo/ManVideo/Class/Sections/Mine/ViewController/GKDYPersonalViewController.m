...
- (void)viewDidLoad {
    ...
    self.categoryView.backgroundColor = [UIColor colorWithHexString:@"1A142D"];
}
...
- (GKDYHeaderView *)headerView {
    if (!_headerView) {
        _headerView = [[GKDYHeaderView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, 333/667.0f*SCREEN_HEIGHT)];
    }
    return _headerView;
}
...
- (UIView *)pageView {
    if (!_pageView) {
        ...
        _pageView.backgroundColor = [UIColor colorWithHexString:@"1A142D"];
...
- (JXCategoryTitleView *)categoryView {
    if (!_categoryView) {
        _categoryView = [[JXCategoryTitleView alloc] initWithFrame:CGRectMake(0, 10, SCREEN_WIDTH, 40.0f)];
        _categoryView.backgroundColor = [UIColor colorWithHexString:@"1A142D"];
