...
@protocol SSAddImageDelegate <NSObject>

- (void)videoUploadComplete:(NSInteger)index pathVideo:(NSString *)path;
...
@property (nonatomic, weak) id<SSAddImageDelegate> delegate;
