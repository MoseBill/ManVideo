...
- (void)sl_getAddressBookPermissions:(UIViewController *)vc {
    ...
    UIAlertController *alertController = [UIAlertController alertControllerWithTitle:NSLocalizedString(@"VDchatFreids", nil) message:NSLocalizedString(@"VDchatPrivacy", nil) preferredStyle:UIAlertControllerStyleAlert];
    UIAlertAction *action_1 = [UIAlertAction actionWithTitle:NSLocalizedString(@"VDDetermine", nil) style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
    ...
    UIAlertAction *action_2 = [UIAlertAction actionWithTitle:NSLocalizedString(@"VDCancelText", nil) style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
