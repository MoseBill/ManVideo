...
- (void)recalculateViewGeometry;
{
    __block CGRect currentViewSize;
    dispatch_async(dispatch_get_main_queue(), ^{
          currentViewSize = self.bounds;
    ...
    runSynchronouslyOnVideoProcessingQueue(^{
        ...
        CGRect insetRect = AVMakeRectWithAspectRatioInsideRect(self->inputImageSize, currentViewSize);
        ...
        switch(self->_fillMode)
        {
            ...
            {
                widthScaling = insetRect.size.width / currentViewSize.size.width;
                heightScaling = insetRect.size.height / currentViewSize.size.height;
            }; break;
            case kGPUImageFillModePreserveAspectRatioAndFill:
            {
                //            CGFloat widthHolder = insetRect.size.width / currentBounds.size.width;
                widthScaling = currentViewSize.size.height / insetRect.size.height;
                heightScaling = currentViewSize.size.width / insetRect.size.width;
            }; break;
        }
